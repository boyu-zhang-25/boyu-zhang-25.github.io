...
Boyu's research interest lies in artificial intelligence (AI) for health. Specifically, he leverages mathematical modeling, machine learning, and non-invasive technology to enable interventions for sleep, circadian rhythm, and holistic well-being. As an interdisciplinary scientist and engineer, Boyu works closely with industry partners, publishes in top venues, and holds multiple patents. Some of Boyu's research outcome has been commercialized. For more information, please request Boyu's CV. 

Bio
---
Boyu has R&D working experience in both tech and pharma. Some current research projects of Boyu are supported by [Samsung Research America](https://sra.samsung.com/) and the [AASM Foundation](https://foundation.aasm.org/strategic-research-award/) (he wrote the grant). 
...
---
Given his personal experience, Boyu is always open to talk to individuals from complex family structures, survived traumatic events, and/or suffered from depression. Please feel free to reach out!

<span style="color:red">**Disclaimer**</span>:
Boyu gets a lot of inquiries, e.g., Ph.D. applications and industry collaboration. Boyu does not provide any medical advice. Boyu is not a healthcare provider by any definition. For industry collaboration, please contact the [MIT Media Lab](https://www.media.mit.edu/about/funding-and-support/) directly. 

Boyu is a Lawful Permanent Resident of the USA. 
