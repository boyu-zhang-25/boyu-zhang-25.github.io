...
Boyu's research interest lies in artificial intelligence (AI) for sleep, circadian rhythm, and mental health. He leverages physiology-informed machine learning, dynamical system modeling, and digital phenotyping to enable accurate sensing and intervention based on non-invasive technologies. As an interdisciplinary scientist and engineer, Boyu works closely with industry partners, publishes in top venues, and holds multiple patents. Some of Boyu's research outcome has been commercialized. For more information, please see Boyu's CV. 
